...
def parse_hypnogram(annot_f, annotation_format="edf++"):
    ...
    good_annot = pd.merge(annot, stages, left_on="EventConcept", right_on="description")
    good_annot = good_annot.sort_values(by="idx_stage").reset_index(drop=True)
