...
try:
    from sleep_staging.utils import ParallelExecutor, load_h5_data, initialize_record, get_class_sequence_idx
except ImportError:
    from sleep_staging.utils.h5_utils import load_h5_data, initialize_record
